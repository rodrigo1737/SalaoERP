...
--
-- Para não descasar histórico financeiro já liquidado, este backfill corrige
-- somente lançamentos pendentes sem baixa parcial.

update public.commissions
set
  commission_value = round((base_value - ((base_value * commission_rate) / 100.0))::numeric, 2),
  updated_at = now()
