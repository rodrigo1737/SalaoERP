...
const Index = () => {
  ...
  const renderPage = () => {
    ...
    switch (currentPage) {
      ...
      case 'commission-matrix': return <Navigate to="/admin?tab=service-rules" replace />;
      ...
      case 'commissions':      return <Navigate to="/app/financial-management?tab=commissions" replace />;
      case 'commission-reprocessing': return <Navigate to="/app/financial-management?tab=commission-reprocessing" replace />;
